...
export const mockData = [
  ...
  { id: 3, visited: false, text: 'Go to Equador', lat: -0.194834, lng: -78.471744, zoom: 10 },
  { id: 4, visited: true, text: 'Go to Malaysia', lat: 4.033869, lng: 101.951179, zoom: 8 },
  { id: 5, visited: true, text: 'Go to Lithuania', lat: 54.884704, lng: 23.903899, zoom: 14 },
  { id: 6, visited: true, text: 'Go to Vietnam', lat: 10.785622, lng: 106.636175, zoom: 12 },
  { id: 7, visited: false, text: 'Go to Holand', lat: 52.360763, lng: 4.886808, zoom: 13 },
  { id: 8, visited: false, text: 'Go to Beirut', lat: 33.884444, lng: 35.504536, zoom: 13 },
  { id: 9, visited: false, text: 'Go to Jerusalem', lat: 31.760442, lng: 35.220756, zoom: 13 },
  { id: 10, visited: true, text: 'Go to Cairo', lat: 30.015112, lng: 31.232141, zoom: 13 },
  { id: 11, visited: false, text: 'Go to Spain', lat: 40.374472, lng: -3.711706, zoom: 13 },
  { id: 12, visited: false, text: 'Go to USA', lat: 38.881742, lng: -77.037574, zoom: 13 },
  { id: 13, visited: false, text: 'Go to Mexico', lat: 19.41075, lng: -99.134828, zoom: 13 },
  { id: 14, visited: false, text: 'Go to Bolivia', lat: -16.525223, lng: -68.127868, zoom: 13 },
];
